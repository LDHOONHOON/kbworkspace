...
-- 한 테이블에는 무조건 클러스트형 인덱스가 하나만 가능하기 때문에
-- 우선 순위가 높은 PK가 클러스터형 인덱스가 되고
-- 나머지 UNIQUE 값들은 모두 보조형이 된다
...
INSERT INTO usertbl VALUES('K나', '성시경', 1979, '서울');
...
-- PK가 변경되면서 클러스터형 인덱스도 함께 변경되어 정렬 순서가 name 순으로 변경됨 (가나다순)ㅑ
SELECT * FROM usertbl;
