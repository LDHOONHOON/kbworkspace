...
-- emplyees 테이블에서 first_name, last_name, gender 컬럼만 출력하기
...
-- usertbl 테이블에서 김경호보다 큰 사람들의 이름과 키를 출력하세요.
...
-- 정렬은 국가코드별로 오름차순으로, 동일한 코드(국가) 안에서는 인구 수의 역순으로 표시하세요.alter
